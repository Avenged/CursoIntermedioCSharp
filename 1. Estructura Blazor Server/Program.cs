using EstructuraBlazorServer.Data;
...
/* Aquí se configuran los middlewares de nuestra aplicación. Recordar
...
/* En C# y en el contexto de aplicaciones web y API, un middleware es un componente de software 
